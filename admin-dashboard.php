						...
						<div class="me-2 mb-2">
							<div class="dropdown">
								...
								<ul class="dropdown-menu  dropdown-menu-end p-3">
									<li>
										<a href="javascript:void(0);" class="dropdown-item rounded-1"><i class="ti ti-file-type-pdf me-1"></i>PDF</a>
									</li>
									<li>
										<a href="javascript:void(0);" class="dropdown-item rounded-1"><i class="ti ti-file-type-xls me-1"></i>Excel </a>
									</li>
								</ul>
							</div>
						</div>
				...
				<div class="card border-0">
					<div class="card-body d-flex align-items-center justify-content-between flex-wrap pb-1">
						...
						<div class="d-flex align-items-center flex-wrap mb-1">
							<a href="#" class="btn btn-primary btn-md me-2 mb-2" data-bs-toggle="modal" data-bs-target="!#add_project"><i class="ti ti-zoom-in me-1"></i>Lihat</a>
						</div>
					</div>
				</div>
				<!-- /Welcome Wrap -->
