...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="modal fade" id="add_assets" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <form action="dc_add.php" method="POST">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Lokasi DC</label>
                                        <input type="text" class="form-control" name="dc_lokasi" placeholder="...">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="upload_csv_modal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <form method="POST" enctype="multipart/form-data" action="dc_upload_csv.php" class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Upload CSV ke Data Center</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
    ...
    <!-- Script Select2 dan sinkronisasi -->
    <script>
