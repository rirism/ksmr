				...
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li>
							<ul>
								<li class="submenu">
									<a href="javascript:void(0);" class=" <?php echo ($page == 'pegawai.php'||$page == 'pangkat.php'||$page == 'jabatan.php'||$page == 'akses.php') ? 'active subdrop' : ''; ?>">
										<i class="ti ti-users"></i><span>Pegawai</span>
										<span class="menu-arrow"></span>
									</a>
									<ul>
										<li><a href="pegawai.php" class="<?php echo ($page == 'pegawai.php') ? 'active' : ''; ?>">Daftar Pegawai</a></li>
										<li><a href="pangkat.php" class="<?php echo ($page == 'pangkat.php') ? 'active' : ''; ?>">Pangkat</a></li>
										<li><a href="jabatan.php" class="<?php echo ($page == 'jabatan.php') ? 'active' : ''; ?>">Jabatan</a></li>
										<li><a href="akses.php" class="<?php echo ($page == 'akses.php') ? 'active' : ''; ?>">Akses</a></li>
									</ul>
								</li>
								<li class="submenu">
						...
						<li>
							<ul>
								...
								<li  class="<?php echo ($page == 'data-pokok.php') ? 'active' : ''; ?>">
									<a href="data-pokok.php">
										<i class="ti ti-database"></i><span>Data Pokok TI</span>
									</a>
								</li>
								<li class="submenu">
									...
									<ul>
										...
										<li>
											<a href="chart-flot.php" class="<?php echo ($page == 'chart-flot.php') ? 'active' : ''; ?>">Likuiditas</a>
										</li>
										<!--<li>
								...
								<li class="submenu">
									...
									<ul>
										...
										<li><a href="employee-report.php" class="<?php echo ($page == 'employee-report.php') ? 'active' : ''; ?>">Laporan Pegawai</a></li>
										<li><a href="daily-report.php" class="<?php echo ($page == 'daily-report.php') ? 'active' : ''; ?>">Laporan Harian</a></li>
										<li><a href="payslip-report.php" class="<?php echo ($page == 'payslip-report.php') ? 'active' : ''; ?>">Laporan Harian</a></li>
									</ul>
								</li>
							</ul>
						</li>
